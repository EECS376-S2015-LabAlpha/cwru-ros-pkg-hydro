...
int main(int argc, char **argv) {
    ros::init(argc, argv, "vel_scheduler_new"); // name of this node will be "minimal_publisher1"
    ...
    double segment_length = 12.00; // desired travel distance in meters; anticipate travelling multiple segments
